...
Ezsparkc is a cython library compiling .C files that use posix calls system. Now you can see the problem here. Just follow me in this journey:
...
-  now navigate to Ezsparkc with MYSYS2 and create the .lib library:
...
- Move libezspark.lib previously built to Python37\libs
