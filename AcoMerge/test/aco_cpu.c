...
int main(){
    ...
    aco_activation* node1 = init_aco_activation(RELU,N_ACTIVATION_FUNCTIONS_1_0,fcl_output1_size,fcl_output1_size,1,0,0,0,NULL,NULL,NULL,generate_all_activations());
    aco_fcl* node2 = init_aco_fcl(fcl_input2_size,fcl_output2_size,2,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node3 = init_aco_activation(RELU,N_ACTIVATION_FUNCTIONS_1_0,fcl_output2_size,fcl_output2_size,3,0,0,0,NULL,NULL,NULL,generate_all_activations());
