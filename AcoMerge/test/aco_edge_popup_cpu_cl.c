...
int main(){
    ...
    aco_cl* node0 = init_aco_cl(1,1,28,28,1,3,3,20,0,1,1,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node1 = init_aco_activation(GELU,N_ACTIVATION_FUNCTIONS_1_0,28*28*20,28*28*20,1,0,0,0,NULL,NULL,NULL,generate_all_activations());
    aco_cl* node2 = init_aco_cl(1,1,28,28,20,3,3,20,2,1,1,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node3 = init_aco_activation(GELU,N_ACTIVATION_FUNCTIONS_1_0,28*28*20,28*28*20,3,0,0,0,NULL,NULL,NULL,generate_all_activations());
    aco_fcl* node4 = init_aco_fcl(28*28*20,fcl_output3_size,4,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node5 = init_aco_activation(SOFTMAX,0,fcl_output3_size,fcl_output3_size,5,0,0,0,NULL,NULL,NULL,NULL);
    
    nodes[0] = init_aco_node(0,0,0,NULL,node0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
    nodes[1] = init_aco_node(0,0,1,NULL,NULL,NULL,NULL,NULL,NULL,node1,NULL,NULL,NULL,NULL);
    nodes[2] = init_aco_node(0,0,2,NULL,node2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
