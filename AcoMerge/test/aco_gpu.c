...
int main(){
    ...
    char** ksource = (char**)malloc(sizeof(char*));//allocation
    ...
    aco_cl* nodem1 = init_aco_cl(padding_rows,padding_cols,input_rows,input_cols,channels,kernel_rows,kernel_cols,n_kernels,0,stride_rows,stride_cols,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_pooling* nodem2 = init_aco_pooling(0,0,input_rows,input_cols,channels,2,2,2,2,1,MAX_POOLING,0,0,NULL,NULL);
    aco_fcl* node0 = init_aco_fcl(fcl_input1_size/4,fcl_output1_size,2,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node1 = init_aco_activation(GELU,0,fcl_output1_size,fcl_output1_size,3,0,0,0,NULL,NULL,NULL,NULL);
    aco_fcl* node2 = init_aco_fcl(fcl_input2_size,fcl_output2_size,4,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    aco_activation* node3 = init_aco_activation(GELU,0,fcl_output2_size,fcl_output2_size,5,0,0,0,NULL,NULL,NULL,NULL);
    aco_fcl* node4 = init_aco_fcl(fcl_input3_size,fcl_output3_size,6,0,0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL);
    
    nodes[0] = init_aco_node(0,0,0,NULL,nodem1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
    nodes[1] = init_aco_node(0,0,1,NULL,NULL,NULL,NULL,nodem2,NULL,NULL,NULL,NULL,NULL,NULL);
    nodes[2] = init_aco_node(0,0,2,node0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
    nodes[3] = init_aco_node(0,0,3,NULL,NULL,NULL,NULL,NULL,NULL,node1,NULL,NULL,NULL,NULL);
    nodes[4] = init_aco_node(0,0,4,node2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
    nodes[5] = init_aco_node(0,0,5,NULL,NULL,NULL,NULL,NULL,NULL,node3,NULL,NULL,NULL,NULL);
    nodes[6] = init_aco_node(0,0,6,node4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
